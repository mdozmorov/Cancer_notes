...
- Stain normalization does not improve model performance. Six stain normalization techniques (Reinhard, Macenko, Structure-preserving Color Normalization, Adaptive Color Deconvolution, StainGAN, StainNet), seven ImageNet CNN architectures, pretrained for IDC grading (Four Breast Cancer Grades). Description of template selection methods, each stain normalization technique. References to previous studies with contradictory results about stain normalization. Datasets: the Four Breast Cancer Grades (FBCG)
Dataset, https://www.kaggle.com/datasets/ambarish/breakhis, and breast carcinoma histological images from the Department of Pathology, https://zenodo.org/record/834910#.WXhxt4jrPcs. <details>
    <summary>Paper</summary>
    Voon, Wingates, Yan Chai Hum, Yee Kai Tee, et al. “Evaluating the Effectiveness of Stain Normalization Techniques in Automated Grading of Invasive Ductal Carcinoma Histopathological Images.” Scientific Reports 13, no. 1 (2023): 20518. https://doi.org/10.1038/s41598-023-46619-6.
</details>
...
- Macenko method for normalizing histology slide colors. Two stain vectors, separate for hematoxylin and eosin - the proportion of each wavelength absorbed. RGB color intensity is -log10 converted to optical density, a product of the stain vectors and the saturation of each of the stains matrices (linear combination of these stain vectors). Transform the image into an optical density (OD) space, estimate the primary stain vectors using Singular Value Decomposition (SVD), separate the image into its stain components, normalize these components to a reference distribution, and then reconstruct the normalized image. [Explanation and Python implementation](https://www.geeksforgeeks.org/machine-learning/macenko-method-for-normalizing-histology-slides-for-quantitative-analysis/). More stain normalization implementations [Stain_Normalization](https://github.com/wanghao14/Stain_Normalization). <details>
    <summary>Paper</summary>
    Macenko, Marc, Marc Niethammer, J. S. Marron, et al. “A Method for Normalizing Histology Slides for Quantitative Analysis.” 2009 IEEE International Symposium on Biomedical Imaging: From Nano to Macro, June 2009, 1107–10. https://doi.org/10.1109/ISBI.2009.5193250.
</details>
...
- TNBC meta analysis of B-cell/immunoglobulin signature (IGG: CD27, CD79A, HLA-C, IGJ, IGKC, IGL, IGLV3-25, IL2RG, CXCL8, LAX1, NTN3, PIM2, POU2AF1, TNFRSF17). Bulk RNA-seq, seven cohorts: SCAN-B (N = 874), BrighTNess (n = 482), CALGB- 40603 (n = 389), METABRIC (n = 267), TCGA (n = 118), GSE58812 (n = 107), GSE21653 (n = 67). Associated with improved EFS, OS, predictive of recurrence and death. Supplementary - download links, Methods - preprocessing. <details>
    <summary>Paper</summary>
    Conte, Benedetta, Fara Brasó-Maristany, Adela Rodríguez Hernández, Tomás Pascual, Guillermo Villacampa, Francesco Schettini, Maria J. Vidal Losada, et al. “A 14-Gene B-Cell Immune Signature in Early-Stage Triple-Negative Breast Cancer (TNBC): A Pooled Analysis of Seven Studies.” eBioMedicine 102 (April 2024): 105043. https://doi.org/10.1016/j.ebiom.2024.105043.
</details>
